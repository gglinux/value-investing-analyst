...
| 第六批 | 假阳性对照整编（替补池全量并入，永久损失硬样本） | 7 | 第五批完成后 | 第五批未遗留未定级 observations；答案直接密封入库（不经 ANSWERS.md 明文） |
...
的假阳性对照案例（看起来该买、事后本金永久损失），从替补池选取（该池已于 2026-09-15
整编为第六批，见五之四；第六批之后的批次须先扩建替补池再混入），答案不经
...
**批纲口径裁决（D4，2026-09-15）**：第四批六案选型**不做调整**。独立核验（报告存仓库外
`b4-answer-audit-20260915/`）显示：VRX / 中石油为全维度本金永久损失；新城在 5 年维度成立
（含息 −75.5%，2024-04 低点 −80.0%）；GE 与福特是 2-3 年深度回撤后部分/完全修复（GE 10 年
含分派 +126.4%、福特 5 年 +2.8%）；分众含息 3 年 +2.40%，属「周期顶盈利腰斩 + 大回撤而非
永久损失」的弱对照。处置：六案仍**全部**标 `fp_control=true` 参与假阳性基线，档位共同语义
按「案发价不可买入（3 年维度亏损）」理解；「永久损失」纯度缺口由第六批（替补池全量整编的
硬样本，见五之四）补偿，分众在第四批 FINDINGS 中登记为弱对照。

**假阳性对照替补池 → 已整编为第六批（2026-09-15 裁决，REQ-P0-01）**

原替补池 7 个候选（康得新 / 瑞幸 / Wirecard / 乐视网 / Kraft Heinz / 东阿阿胶 / 长生生物）
已全量编入第六批，案例表与执行说明见**五之四**，本节不再单独维护候选清单。第六批之后的
批次如需新的假阳性对照，须先按原选池标准扩建替补池：回放时点利润真实（或看起来真实）、
护城河叙事成立、估值指标不难看、事后本金永久损失 ≥50%；候选须标注放行路径，优先选与
当批主题**同类型**的对照，使对照与正向样本共享同一条估值通道，判别力才可比。
第三批实际执行时未混入对照（fp_control 机制当时未实现，已知缺口，由第四批 + 第六批的
对照厚度补偿）；第五批的对照为案例 28（诺基亚）。
...
## 五之四、第六批案例：假阳性对照整编——永久损失硬样本

2026-09-15 裁决（D4 的补偿批）：第四批核验显示其六案中约半数在 5 年以上维度并非本金
永久损失（GE 10 年含分派 +126.4%、福特 5 年 +2.8%、分众含息 3 年 +2.40%），假阳性基线的
「永久损失」检验强度弱于批纲设计。本批把原替补池 7 个候选全量整编为独立批次，与第四批
合计 13 例对照——其中本批 7 案均为「事后本金永久损失 ≥50% 且不可逆（退市 / 破产 / 造假
坐实）」的硬样本，为 fade 期绑定修法、MoS 降档等放松性改动提供**第二级**解冻证据。

| # | 标的 | 回放时点 | 放行路径（测哪道闸门会放） | 事后 |
|---|---|---|---|---|
| 31 | 康得新 002450.SZ | 2017-12-31 | 存贷双高但净利率极高、成长叙事强；测 Phase 0 存贷双高在「高增长解释」下会不会被人工豁免 | 2019 年 119 亿造假，退市 |
| 32 | 瑞幸 LK | 2019-11-30 | 单位经济叙事 + 高增长；测成长股通道（REQ-P1-01）对无利润公司的下限 | 2020-04 承认造假，退市 |
| 33 | Wirecard WDI.DE | 2019-06-30 | DAX 成分、四大审计、高 ROE；测审计意见非标以外的排雷条款能否命中「审计通过的造假」 | 2020-06 破产 |
| 34 | 乐视网 300104.SZ | 2016-06-30 | 生态叙事 + 关联交易；测其他应收 / 关联方条款 | 2018 停牌，2020 退市 |
| 35 | Kraft Heinz KHC | 2017-12-31 | 巴菲特持股 + 宽护城河叙事 + 高股息；测「名投资者背书」是否进入护城河证据 | 2019 商誉减值 154 亿美元，股价 -60% |
| 36 | 东阿阿胶 000423.SZ | 2018-06-30 | 品牌护城河 + 连续提价 + 高 ROE；测渠道压货（应收 / 存货剪刀差）能否在提价叙事下命中 | 2019 首亏，股价 -55% |
| 37 | 长生生物 002680.SZ | 2018-03-31 | 高毛利 + 高增长疫苗龙头；测系统对「监管 / 治理尾部风险」的能力边界声明（与案例 24 同型） | 2018-07 疫苗造假，强制退市 |

**执行说明**：

- 七案**全部**标 `fp_control=true`（批次 ≥4，runner 的 FP_CONTROL_MISSING 门禁天然满足）。
- 案例条目**只登记案例设计信息**，不含答案细节（事后列仅为选池依据，档位期望与
  must_trigger 在密封时才写入）；答案不经 ANSWERS.md 明文中转、直接密封入库，密封时按
  REQ-P2-01 预注置信度（靶在箭前）。
- 执行前置：第五批完成后开跑；第四批假阳性基线已建立（本批是其**加厚**，不是替代）——
  两批 13 例对照中约半数为硬永久损失样本，弥补第四批「名实不符」的批纲缺口。
- 案例 31（康得新）与第二批案例 7（神华）同为「高盈利 + 强叙事」，若 Phase 0 对两者的
  存贷双高 / 现金质量读数一致而结局相反，说明该条款挂错了字段——这是本批最锋利的测点。

**样本设计决议（P1-6，2026-09-17 用户裁决）**：康美型「账面便宜的坏公司」负样本——
MoS≥25%、E[IRR]≥r、能通过闸门一走到闸门二被拒的形态——**放第七批**，与 W3 波次
闸门放松（REQ-P0-04）的验证需求同步：该负样本的真正价值在测试「闸门二放松后是否
破防」，与放松性改动的落地同批才有验证时序意义。第四批 6 案选型**不做任何调整**
（D4 裁决已冻结，中途换样本会破坏假阳性基线可比性）；Wirecard `fp_control` 对照
已在第六批案例 33 落位。第四批空证问题（0/8 负样本在闸门一被拦、闸门二放松未被
测试）由第六/七批样本补齐后自然闭合。
